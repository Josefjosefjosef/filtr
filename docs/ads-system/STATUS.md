...
**Current stage:** Etapa 1 **DONE** · Etapa 2 **DONE** (#7684 merged) · Etapa 3 **DONE** (#7687 merged) · Etapa 4 in progress (campaigns/placements/creatives)  
...
## Etapa 4 — campaigns/placements/creatives (in progress)
...
| 4 | in progress — campaigns/placements/creatives |
| 5–9 | pending |
