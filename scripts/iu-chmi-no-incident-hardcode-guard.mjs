...
ok("has_listRecentForOnsetLedger", /listRecentForOnsetLedger|ONSET_LEDGER_RECENT_PER_STREAM/.test(prod));
ok("has_references_traversal", /resolveReferenceChainEntries/.test(prod));
ok("no_sole_listRecent_6", !/listRecentForOnsetLedger\(\s*6\s*\)/.test(prod));
