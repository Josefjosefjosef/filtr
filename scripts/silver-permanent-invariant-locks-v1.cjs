...
const LOCKS = [
  ...
  "silver-capability-isolation-regression-guard.cjs",
  "silver-session-state-governance-regression-guard.cjs",
  "silver-memory-budget-regression-guard.cjs",
  "silver-orphan-cleanup-regression-guard.cjs",
  "silver-runtime-state-pruning-regression-guard.cjs",
  "silver-long-session-runtime-regression-guard.cjs",
