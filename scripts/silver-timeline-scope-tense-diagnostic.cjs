/**
 * SILVER timeline_scope_and_tense cluster diagnostic (replay + safety guards).
 * harness_id: silver_timeline_scope_tense_diagnostic_v1
 */
...
const HARNESS_ID = "silver_timeline_scope_tense_diagnostic_v1";
const TARGET_CLUSTER = "timeline_scope_and_tense";
const FIXED_NOW_ISO = "2026-05-04T12:00:00";
const REPORT_JSON = path.join(__dirname, "silver-timeline-scope-tense-diagnostic-report.json");
...
function buildSeed() {
  const events = [
    ...
    { id: "e_servis", date: VCERA, time: "09:00", title: "Servis", address: "Hlavní 12 Ostrava", note: "kontrola auta" },
    { id: "e_kontrola", date: VCERA, time: "14:00", title: "Kontrola", address: "Praha", note: "technická kontrola" },
    { id: "e_jednani", date: TODAY, time: "11:00", title: "Jednání", address: "", note: "interní jednání" },
    { id: "e_schuzka", date: ZITRA, time: "15:00", title: "Schůzka s Petrem", address: "", note: "probrat smlouvu" },
    { id: "e_termin", date: TODAY, time: "16:30", title: "Termín u úřadu", address: "Praha 4", note: "" },
    { id: "e_pohovor", date: VCERA, time: "10:00", title: "Pohovor", address: "Brno", note: "pracovní pohovor" },
    { id: "e_doktor", date: ZITRA, time: "09:00", title: "Doktor", address: "Vinohradská 3 Praha", note: "vzít zprávu" },
    { id: "e_doktor_past", date: VCERA, time: "08:30", title: "Doktor", address: "Vinohradská 3 Praha", note: "minulá návštěva" }
  ];
  const tasks = [
    ...
    { id: "t_dokumenty", title: "poslat dokumenty", status: "todo", dueAt: null, note: "", priority: "medium", createdAt: 1, updatedAt: 1 },
    { id: "t_darek", title: "koupit dárek", status: "todo", dueAt: null, note: "", priority: "medium", createdAt: 1, updatedAt: 1 }
  ];
  const notes = [
    { id: "n_heslo", title: "Heslo", content: "heslo k bance je doma", createdAt: 1, updatedAt: 1, pinned: false, tags: [], deleted: false },
    { id: "n_banka", title: "Banka", content: "poznámka o bance v šuplíku", createdAt: 1, updatedAt: 1, pinned: false, tags: [], deleted: false },
...
function buildCases() {
  const pos = [
    { id: "tl_pos_01", polarity: "positive", input: "Kdy jsem měl kurýra?", expectedIntent: "calendar.query" },
    { id: "tl_pos_02", polarity: "positive", input: "Kdy jsem měla kurýra?", expectedIntent: "calendar.query" },
    { id: "tl_pos_03", polarity: "positive", input: "Kdy jsem měl servis?", expectedIntent: "calendar.query" },
    { id: "tl_pos_04", polarity: "positive", input: "Kdy jsem měla kontrolu?", expectedIntent: "calendar.query" },
    { id: "tl_pos_05", polarity: "positive", input: "Kdy jsem měl jednání?", expectedIntent: "calendar.query" },
    { id: "tl_pos_06", polarity: "positive", input: "Kdy jsem měla schůzku?", expectedIntent: "calendar.query" },
    { id: "tl_pos_07", polarity: "positive", input: "Kdy jsem měl termín?", expectedIntent: "calendar.query" },
    { id: "tl_pos_08", polarity: "positive", input: "Kdy jsem měla termín?", expectedIntent: "calendar.query" },
    { id: "tl_pos_09", polarity: "positive", input: "Kdy jsem měl pohovor?", expectedIntent: "calendar.query" },
    { id: "tl_pos_10", polarity: "positive", input: "Kdy jsem měla doktora?", expectedIntent: "calendar.query" }
  ];
  const neg = [
    { id: "tl_neg_11", polarity: "negative", input: "Kdy jsem měl koupit mléko?", expectNoWrite: true, forbidCalendarRead: true },
    { id: "tl_neg_12", polarity: "negative", input: "Kdy jsem měla koupit mléko?", expectNoWrite: true, forbidCalendarRead: true },
    { id: "tl_neg_13", polarity: "negative", input: "Kdy jsem měl zavolat mámě?", expectNoWrite: true, forbidCalendarRead: true },
    { id: "tl_neg_14", polarity: "negative", input: "Kdy jsem měla zaplatit nájem?", expectNoWrite: true, forbidCalendarRead: true },
    { id: "tl_neg_15", polarity: "negative", input: "Kdy jsem měl udělat úkol?", expectNoWrite: true, forbidCalendarRead: true },
    { id: "tl_neg_16", polarity: "negative", input: "Kdy jsem měla poslat dokumenty?", expectNoWrite: true, forbidCalendarRead: true },
    { id: "tl_neg_17", polarity: "negative", input: "Kdy jsem si poznamenal heslo?", expectNoWrite: true, forbidNoteCreate: true },
    { id: "tl_neg_18", polarity: "negative", input: "Kdy jsem ukládal poznámku o bance?", expectNoWrite: true, forbidNoteCreate: true },
    { id: "tl_neg_19", polarity: "negative", input: "Jen se ptám, kdy jsem měl kurýra, nic neukládej.", expectNoWrite: true },
    { id: "tl_neg_20", polarity: "negative", input: "Nechci nic vytvářet, kdy jsem měla kurýra?", expectNoWrite: true },
    { id: "tl_neg_21", polarity: "negative", input: "Kdy jsem měl kurýra, ale nic nepřidávej.", expectNoWrite: true },
    { id: "tl_neg_22", polarity: "negative", input: "Kdy jsem měla schůzku v kalendáři?", expectNoWrite: true, expectedIntent: "calendar.query" },
    { id: "tl_neg_23", polarity: "negative", input: "Kdy jsem měla koupit dárek v úkolech?", expectNoWrite: true, forbidCalendarRead: true },
    { id: "tl_neg_24", polarity: "negative", input: "Kdy jsem si zapsala poznámku o právníkovi?", expectNoWrite: true, forbidNoteCreate: true }
  ];
  return pos
...
function classifyBucket(c, turn, ev) {
  ...
  if (c.polarity === "positive") {
    ...
    if (eng === "clarification" || /upresni|upřesni/i.test(raw)) return "true_engine_fail";
  ...
  if (c.forbidCalendarRead && eng === "calendar.read" && ev.pass === false) {
...
function main() {
  ...
  const recommendedFixScope = readyForFix
    ? "assets/app.js — extend iuSilverP1PastCalendarRetrievalAppointmentEntityFolded (kuryr, servis) + replay diagnostic"
    : safetyRisk > 0
  ...
  const report = {
    ...
    alias_timeline_mismatch_count: buckets.alias_timeline_mismatch || 0,
  ...
  console.log("=== SILVER_TIMELINE_SCOPE_TENSE_DIAGNOSTIC ===");
  ...
  console.log("alias_timeline_mismatch_count=" + report.alias_timeline_mismatch_count);
  ...
  console.log("=== END_SILVER_TIMELINE_SCOPE_TENSE_DIAGNOSTIC ===");
}
