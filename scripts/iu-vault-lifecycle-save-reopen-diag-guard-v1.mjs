...
async function main() {
  ...
  try {
    ...
    if (!/iu-vault-canary-diag-v1-20260830|iu-vault-canonical-durable-v1-20260830|iu-vault-hydrated-owns-ui-v1-20260829|iu-vault-key-path-atomic-v1-20260829|iu-vault-hydrated-prefs-ui-v1-20260829|iu-vault-lifecycle-diag-v1-20260829/.test(index)) fails.push("index_missing_cache_bust");
    if (!/2026-08-30-iu-vault-canary-diag-v1|2026-08-30-iu-vault-canonical-durable-v1|2026-08-29-iu-vault-hydrated-owns-ui-v1|2026-08-29-iu-vault-key-path-atomic-v1|2026-08-29-iu-vault-hydrated-prefs-ui-v1|2026-08-29-iu-vault-lifecycle-diag-v1/.test(sw)) fails.push("sw_missing_cache_version");
