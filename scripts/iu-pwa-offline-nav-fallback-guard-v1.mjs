...
function auditStatic() {
  ...
  if (!sw.includes("2026-07-30-chmi-cap-concrete-url-chrono-v1")) fails.push("sw:missing CACHE_VERSION bump");
    ...
    JSON.stringify(
      {
        ...
        passes,
        failures,
        cacheVersion: "2026-07-30-chmi-cap-concrete-url-chrono-v1",
      },
      null,
      2
    )
