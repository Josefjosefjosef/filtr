#!/usr/bin/env node
/**
 * silver-calendar-write-20k-regression-guard.cjs
 * Permanent guard: calendar_write slice must stay 3000/3000.
 */
"use strict";
...
const TARGET = 3000;
const GROUP = "calendar_write";

function main() {
  const r = run20kSliceGuard(GROUP, TARGET);
  console.log("=== SILVER_CALENDAR_WRITE_20K_REGRESSION_GUARD ===");
  console.log("guard_id=silver_calendar_write_20k_regression_guard_v1");
  ...
  console.log("=== END_SILVER_CALENDAR_WRITE_20K_REGRESSION_GUARD ===");
