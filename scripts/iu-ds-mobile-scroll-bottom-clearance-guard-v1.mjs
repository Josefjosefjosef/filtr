...
function staticGate() {
  ...
  const checks = [
    ...
    {
      id: "index_cache_bust",
      pass: /iu-overlay-mobile-tablet-unified-v1\.css\?v=ds-mobile-overlay-nav-flush-v1-20260713-bottom-nav-keyboard-hide-v1-20260802-ds-full-height-v1-20260803/.test(index),
    },
  ];
