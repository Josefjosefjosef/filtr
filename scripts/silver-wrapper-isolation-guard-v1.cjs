...
const SCRIPT = path.join(__dirname, "silver-wrapper-isolation-audit-v1.cjs");
...
function main() {
  ...
  console.log("=== SILVER_WRAPPER_ISOLATION_GUARD_V1 ===");
  console.log("PASS_FAIL=" + (ok ? "PASS" : "FAIL"));
  console.log("=== END_SILVER_WRAPPER_ISOLATION_GUARD_V1 ===");
  process.exit(ok ? 0 : 1);
}
