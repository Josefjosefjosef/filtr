...
const UNIZDRAV_MARKER = "affiliate-unizdrav-zdravi-doplnky-v1-20260924";
const CATALOG_BUST = UNIZDRAV_MARKER;
...
function auditStatic() {
  ...
  ok("index_unizdrav_marker", index.includes(UNIZDRAV_MARKER));
