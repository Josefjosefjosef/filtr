#!/usr/bin/env node
/**
 * silver-task-query-20k-regression-guard.cjs
 * Permanent guard: task_query slice must stay 3000/3000.
 */
"use strict";
...
const TARGET = 3000;
const GROUP = "task_query";

function main() {
  const r = run20kSliceGuard(GROUP, TARGET);
  console.log("=== SILVER_TASK_QUERY_20K_REGRESSION_GUARD ===");
  console.log("guard_id=silver_task_query_20k_regression_guard_v1");
  ...
  console.log("=== END_SILVER_TASK_QUERY_20K_REGRESSION_GUARD ===");
