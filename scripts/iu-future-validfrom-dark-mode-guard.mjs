...
function staticGate() {
  ...
  ok("freeze_manifest_bumped", /traffic-ui-hero-cta-early-v1-20260808/.test(fs.readFileSync(path.join(ROOT, "docs", "pre-aggregator-stable", "freeze-manifest.json"), "utf8")), "freeze");
