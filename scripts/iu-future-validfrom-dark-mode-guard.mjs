...
function staticGate() {
  ...
  ok("freeze_manifest_bumped", /traffic-ui-activation-v1-20260807/.test(fs.readFileSync(path.join(ROOT, "docs", "pre-aggregator-stable", "freeze-manifest.json"), "utf8")), "freeze");
