...
const SCAN_GLOBS = [
  ...
  "scripts/silver-notes-v2-ux-guard-v1-shared.cjs",
  ...
  "scripts/run-silver-notes-v2-ux-guard-against-checkout.cjs",
  "scripts/run-silver-home-prefix-first-tap-guard-against-checkout.cjs",
  "scripts/smoke.mjs",
  "scripts/iu-root-routing-prod-guard.mjs",
  "scripts/mobile-stability-guards-v1-shared.cjs",
  "scripts/bottom-navigation-visibility-guard-v1.cjs",
  "scripts/mobile-navigation-stability-guard-v1.cjs",
  "scripts/media-cls-guard-v1.cjs",
  "scripts/media-load-more-scroll-guard-v1.cjs",
  "scripts/silver-copy-guard-v1.cjs",
  "scripts/iu-mobile-tablet-bottom-nav-unify-guard-v1.mjs",
  "scripts/iu-mobile-bottom-nav-keyboard-hide-guard-v1.mjs",
