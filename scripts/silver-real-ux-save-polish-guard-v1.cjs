...
const SCRIPT = path.join(__dirname, "silver-real-ux-save-polish-audit-v1.cjs");
...
function main() {
  ...
  console.log("=== SILVER_REAL_UX_SAVE_POLISH_GUARD_V1 ===");
  console.log("PASS_FAIL=" + (ok ? "PASS" : "FAIL"));
  console.log("=== END_SILVER_REAL_UX_SAVE_POLISH_GUARD_V1 ===");
  process.exit(ok ? 0 : 1);
}
