...
export function emptyHealth() {
  return {
    ...
    LAST_PUBLICATION_SUCCESS_AT: null,
    LAST_PUBLICATION_HTTP_STATUS: null,
    PUBLICATION_CONSECUTIVE_FAILURES: 0,
    PUBLICATION_RETRY_COUNT: 0,
    LAST_PUBLICATION_GENERATION_ATTEMPTED: null,
    LAST_PUBLICATION_GENERATION_SUCCESSFUL: null,
