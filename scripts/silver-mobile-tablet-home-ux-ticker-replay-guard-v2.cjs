...
async function main() {
  ...
  emitV2Banner("SILVER_MOBILE_TABLET_HOME_UX_TICKER_REPLAY_GUARD_V2", path.join("scripts", "silver-mobile-tablet-home-ux-ticker-replay-guard-v2-report.json"), out);
}
