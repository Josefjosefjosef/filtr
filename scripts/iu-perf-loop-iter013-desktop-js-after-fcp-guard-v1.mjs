...
must(/data-iu-desktop-js="1"[^>]*data-iu-module="1"[^>]*data-iu-src="[^"]*iu-desktop-info-panel\.js/.test(index), "info_panel:data_src");
...
must(!/<script[^>]*\ssrc="[^"]*iu-desktop-info-panel\.js/.test(index), "info_panel:no_early_src");
