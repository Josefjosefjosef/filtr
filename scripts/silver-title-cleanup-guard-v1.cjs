...
const SCRIPT = path.join(__dirname, "silver-title-cleanup-audit-v1.cjs");
...
function main() {
  ...
  console.log("=== SILVER_TITLE_CLEANUP_GUARD_V1 ===");
  console.log("PASS_FAIL=" + (ok ? "PASS" : "FAIL"));
  console.log("=== END_SILVER_TITLE_CLEANUP_GUARD_V1 ===");
  process.exit(ok ? 0 : 1);
}
