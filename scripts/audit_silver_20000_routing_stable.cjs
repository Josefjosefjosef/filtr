...
function gitTrackedClean() {
  try {
    ...
    const allow = [
      ...
      "assets/app.js",
      "scripts/silver-save-understanding-audit-shared.cjs",
      "scripts/silver-save-payload-intelligence-line-k-shared.cjs",
      "scripts/silver-conversational-continuation-audit-v1.cjs",
      "scripts/silver-conversational-continuation-regression-guard.cjs",
      "scripts/silver-save-payload-decomposition-v2-audit-v1.cjs",
      "scripts/silver-save-payload-decomposition-v2-regression-guard.cjs",
      "scripts/silver-chained-save-refinement-audit-v1.cjs",
      "scripts/silver-chained-save-refinement-regression-guard.cjs",
      "scripts/silver-context-carry-over-audit-v1.cjs",
      "scripts/silver-context-carry-over-regression-guard.cjs",
      "scripts/silver-edit-understanding-audit-v1.cjs",
      "scripts/silver-edit-understanding-regression-guard.cjs",
      "scripts/silver-long-human-save-understanding-audit-v1.cjs",
      "scripts/silver-long-human-save-understanding-regression-guard.cjs",
      ...
      "scripts/silver-runtime-layer-segmentation-diagnostic-v1.cjs",
      "scripts/silver-runtime-layer-segmentation-regression-guard.cjs",
      "scripts/silver-runtime-layer-segmentation-diagnostic-v1-report.json",
      "scripts/silver-public-beta-governance-guard-v1.cjs",
      "scripts/silver-public-beta-governance-regression-guard.cjs",
      "scripts/silver-capability-safety-audit-v1.cjs",
      "scripts/silver-czech-morphology-audit-v1.cjs"
    ];
