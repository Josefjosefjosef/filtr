...
-- Etapa 7 (appended for local/schema reference)
-- Etapa 7 â€” Client access codes + portal (kap. 36â€“38).
...
-- Etapa 8 (appended for local/schema reference)
...
-- Etapa 9 (appended for local/schema reference)
-- Etapa 9 ? Backup / security closeout (kap. 14 + kap. 34).
