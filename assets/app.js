...
function iuInjectMindMenuAd() {
  const container = document.querySelector("aside.accordionCol > .iuRightTopCtas");
  if (!container || document.querySelector(".iuRightTopCtas .iu-ad")) return;
  const ad = document.createElement("div");
  ad.className = "iu-ad";
  ad.setAttribute("aria-label", "Inzerce");
  ad.innerHTML = '<span class="iu-ad-title">Ukázkový inzerát</span><p class="iu-ad-text">Text inzerátu – gradient pouze na písmo.</p><a href="#" class="iuRightCta iuRightCta--submit" role="button">Více</a>';
  container.appendChild(ad);
}
if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", iuInjectMindMenuAd);
else setTimeout(iuInjectMindMenuAd, 0);
