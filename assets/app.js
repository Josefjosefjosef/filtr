  ...
  window.IU_QUICK_FEEDS = {
    ai: {
      ...
      items: [
        ...
        { name: "Claude", url: "https://claude.ai", desc: "Claude – AI s přirozeným stylem psaní, vhodná pro texty a brainstorming.", external: true, color: "#D97706", video: "X1FOhLxFQqo" },
...
(function(){
  ...
  const AI_FALLBACK = [
    ...
    { name: "Claude", url: "https://claude.ai", desc: "Claude – AI s přirozeným stylem psaní, vhodná pro texty a brainstorming." },
