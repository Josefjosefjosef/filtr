  ...
  window.IU_QUICK_FEEDS = {
    ai: {
      ...
      items: [
        ...
        { name: "Claude", url: "https://claude.ai", desc: "Claude – AI s přirozeným stylem psaní, ideální pro texty, analýzy a kreativní brainstorming.", external: true, color: "#D97706", video: "X1FOhLxFQqo" },
...
(function(){
  ...
  const AI_FALLBACK = [
    ...
    { name: "Claude", url: "https://claude.ai", desc: "Claude – AI s přirozeným stylem psaní, ideální pro texty, analýzy a kreativní brainstorming." },
