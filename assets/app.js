...
function buildVideoAsArticleCard(it) {
  ...
  function iuNakupDomuInit(){
    ...
    closeBtn?.addEventListener("click", (e) => {
      ...
      const cardInQuick = q && q.querySelector(".iuModalCard");
      if (cardInQuick && typeof window.iuNakupCloseQuickView === "function") window.iuNakupCloseQuickView();
      else iuNakupClose();
    ...
    modal?.addEventListener("click", (e) => {
      if (e.target === modal) {
        const q = document.getElementById("iuQuickFeed");
        if (q && q.querySelector(".iuModalCard")) { if (typeof window.iuNakupCloseQuickView === "function") window.iuNakupCloseQuickView(); } else iuNakupClose();
        try { if (typeof window.iuSetPanelInUrl === 'function') window.iuSetPanelInUrl(''); } catch {}
      }
    });
    document.addEventListener("keydown", (e) => {
      if (e.key === "Escape") {
        const q = document.getElementById("iuQuickFeed");
        const cardInQuick = q && q.querySelector(".iuModalCard");
        if (cardInQuick && typeof window.iuNakupCloseQuickView === "function") { window.iuNakupCloseQuickView(); try { if (typeof window.iuSetPanelInUrl === 'function') window.iuSetPanelInUrl(''); } catch {} }
        else {
