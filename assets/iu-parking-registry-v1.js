...
export const PARKING_REGISTRY = Object.freeze([
  ...
  // Completeness vs OKAS operated list (2026-09-10): facilities previously missing from registry.
  Object.freeze({
    parkingId: "ostrava-janackova",
    canonicalName: "Janáčkova",
    municipality: "Ostrava",
    cityPart: null,
    street: "Janáčkova",
    addressLine: null,
    ...
    parkAndRide: false,
    shortExplanation: null,
    aliases: Object.freeze(["janackova"]),
    sources: Object.freeze([
      {
        label: "Ostravské komunikace, a.s. — Provozovaná parkoviště",
        url: "https://www.okas.cz/hlavni-cinnosti/parkovani.html",
  ...
  Object.freeze({
    parkingId: "ostrava-seidlerovo-nabrezi",
    canonicalName: "Seidlerovo nábřeží",
    municipality: "Ostrava",
    cityPart: null,
    street: null,
    addressLine: null,
    ...
    parkAndRide: false,
    shortExplanation: null,
    aliases: Object.freeze(["seidlerovo nabrezi"]),
    sources: Object.freeze([
      {
        label: "Ostravské komunikace, a.s. — Provozovaná parkoviště",
        url: "https://www.okas.cz/hlavni-cinnosti/parkovani.html",
  ...
  Object.freeze({
    parkingId: "ostrava-pr-hlucinska",
    canonicalName: "P+R Hlučínská",
    municipality: "Ostrava",
    cityPart: null,
    street: "Hlučínská",
    addressLine: null,
    ...
    parkingType: "P+R",
    parkAndRide: true,
    shortExplanation: PARK_AND_RIDE_EXPLANATION_CS,
    aliases: Object.freeze([
      "p+r hlucinska",
      "pr hlucinska",
      "hlucinska",
  ...
  Object.freeze({
    parkingId: "ostrava-garaze-dubina",
    // OKAS canonical: Patrové garáže Dubina. NDIC live label often: Garáže Dubina.
    canonicalName: "Patrové garáže Dubina",
    municipality: "Ostrava",
    cityPart: "Dubina",
    street: null,
    addressLine: null,
    ...
    sources: Object.freeze([
      ...
      {
        label: "Ostravské komunikace, a.s. — Garáže Dubina (PDF)",
        url: "https://www.okas.cz/userfiles/Files/parkovani/Garaze%20dubina(1).pdf",
      },
    ]),
    lastVerified: "2026-09-10",
  }),
  Object.freeze({
    parkingId: "ostrava-parkovaci-dum-u-mnof",
    canonicalName: "Parkovací dům u MNOF",
    municipality: "Ostrava",
    cityPart: null,
    street: null,
    addressLine: null,
  ...
  Object.freeze({
    parkingId: "ostrava-dk-poklad-2",
    canonicalName: "Parkovací dům DK POKLAD II.",
    municipality: "Ostrava",
    cityPart: "Poruba",
    street: null,
    addressLine: null,
    ...
    shortExplanation: null,
    aliases: Object.freeze([
      "parkovaci dum dk poklad ii",
      "parkovaci dum dk poklad 2",
      "dk poklad ii",
      "dk poklad 2",
      "poklad ii",
    ]),
  ...
  Object.freeze({
    parkingId: "ostrava-pr-hranecnik",
    canonicalName: "P+R Hranečník",
    municipality: "Ostrava",
    cityPart: null,
    street: null,
    addressLine: null,
